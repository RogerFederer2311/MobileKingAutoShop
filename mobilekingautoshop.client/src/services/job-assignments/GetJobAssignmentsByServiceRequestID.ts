...
import IGetJobAssignmentsByServiceRequestID from "../../interfaces/services/job-assignments/IGetJobAssignmentsByServiceRequestID";
...
export default async function getJobAssignmentsByServiceRequestID(props: IGetJobAssignmentsByServiceRequestID) {
